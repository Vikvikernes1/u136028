...
Class homework_control extends CModule
{
    /*Обязательные свойства объекта модуля*/
    const MODULE_ID = "homework.control";
    var $MODULE_ID = "homework.control";
    var $MODULE_VERSION;
    ...
    function __construct()
    {
        ...
        $this->MODULE_NAME = GetMessage("homework.control_MODULE_NAME");
        $this->MODULE_DESCRIPTION = GetMessage("homework.control_MODULE_DESC");

        $this->PARTNER_NAME = GetMessage("homework.control_PARTNER_NAME");
        $this->PARTNER_URI = GetMessage("homework.control_PARTNER_URI");
    }
